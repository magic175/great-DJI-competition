...
(cl:defmethod cl:initialize-instance :after ((m <WayPoints>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WayPoints)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name path_sender-msg:<WayPoints> is deprecated: use path_sender-msg:WayPoints instead.")))

(cl:ensure-generic-function 'points-val :lambda-list '(m))
(cl:defmethod points-val ((m <WayPoints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader path_sender-msg:points-val is deprecated.  Use path_sender-msg:points instead.")
  (points m))
